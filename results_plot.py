...
mlp_epochs, mlp_train_mae, mlp_val_mae = extract_data("mlp_results.txt")
cnn_epochs, cnn_train_mae, cnn_val_mae = extract_data("simple_cnn_results.txt")
deep_epochs, deep_train_mae, deep_val_mae = extract_data("deep_cnn_results.txt")
